/**
 * @author zhixin wen <wenzhixin2010@gmail.com> version: 1.3.0
   ...
   if(colentpage==null||colentpage==''){
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatRecordsPerPage: function (pageNumber) {
        	// return return '每页显示 ' + pageNumber + ' 条记录';
        ...
        formatSearch: function (fieldText) {
            return fieldText;
        },
    ...
    BootstrapTable.prototype.initTable = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            that.options.columns[i] = $.extend({}, BootstrapTable.COLUMN_DEFAULTS,
                {field: i}, column); // when field is undefined, use index
										// instead
        });
            ...
            html.push(
                '<div class="pull-right search">',
                    sprintf('<input class="form-control" type="text" placeholder="%s">',
                        this.options.formatSearch(this.options.fieldText)),
                '</div>');
    ...
    BootstrapTable.prototype.onPageNumber = function (event) {
    	colentpage=$(event.currentTarget).text();
