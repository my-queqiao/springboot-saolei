...
(function(g) {
    ...
    g.extend(p.prototype, {
        ...
        parseTable: function() {
            ...
            a && (typeof a === "string" && (a = document.getElementById(a)), k(a.getElementsByTagName("tr"),
            function(b, a) {
        ...
        parseGoogleSpreadsheet: function() {
            ...
            e && jQuery.ajax({
                ...
                success: function(a) {
                    ...
                    j = Math.max(j, e.gs$cell.row);
                    for (l = 0; l < m; l++) if (l >= h && l <= n) f[l - h] = [],
                    f[l - h].length = Math.min(j, c - d);
                    for (l = 0; l < k; l++) if (e = a[l], i = e.gs$cell.row - 1, g = e.gs$cell.col - 1, g >= h && g <= n && i >= d && i <= c) f[g - h][i - d] = e.content.$t;
                    b.dataFound()
                }
            })
        },
        ...
        parseColumn: function(b, a) {
            ...
            for (e[a] || (e[a] = []); d--;) if (c = o[d] || b[d], g = this.trim(c), i = this.trim(c, !0), h = parseFloat(i), e[a][d] === void 0 && (e[a][d] = g), q || d === 0 && k) b[d] = g;
            else if ( + i === h) b[d] = h,
            ...
            j && b.mixed && (f[a] = e[a]);
            if (j && m && this.options.sort) for (a = 0; a < f.length; a++) f[a].reverse(),
            k && f[a].unshift(f[a].pop())
        },
        dateFormats: {
            "YYYY-mm-dd": {
        ...
        parseDate: function(b) {
            ...
            if (a) e = a(b);
                ...
                c || (c = Date.parse(b), typeof c === "object" && c !== null && c.getTime ? e = c.getTime() - c.getTimezoneOffset() * 6E4: typeof c === "number" && !isNaN(c) && (e = c - (new Date(c)).getTimezoneOffset() * 6E4))
            }
            return e
        },
